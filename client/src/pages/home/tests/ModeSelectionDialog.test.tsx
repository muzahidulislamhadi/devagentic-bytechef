...
it('should show dialog when isDialogOpen is true', () => {
    ...
    expect(screen.getByText('Select how you will use DevAgentic')).toBeInTheDocument();
});
...
it('should not show dialog when isDialogOpen is false', () => {
    ...
    expect(screen.queryByText('Select how you will use DevAgentic')).not.toBeInTheDocument();
});
